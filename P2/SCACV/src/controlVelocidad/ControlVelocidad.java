...
public class ControlVelocidad {
	...
	private ControlAutomatico automatico;
	private Motor motor;
	private PalancaCambios palanca;
	...
	public ControlVelocidad(int intervalo) {
		...
		automatico = new ControlAutomatico(acelerador, freno, registro, eje);
		motor = new Motor();
		palanca = new PalancaCambios();
