...
public class VentanaControl extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        boton_encendido = new javax.swing.JButton();
        ...
        boton_encendido.setText("APAGADO");
        ...
        boton_frenar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                boton_frenarActionPerformed(evt);
            }
        });
    ...
    private void boton_acelerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_acelerarActionPerformed
        if(this.etiqueta_estado.getText().equals("ACELERAR")){
            this.etiqueta_estado.setText("ACELERANDO");
            this.boton_acelerar.setText("SOLTAR ACELERADOR");
        }else{
            this.etiqueta_estado.setText("ENCENDIDO");
            this.boton_encendido.setText("ACELERAR");
        }
    }//GEN-LAST:event_boton_acelerarActionPerformed

    private void boton_frenarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_frenarActionPerformed
    ...
    }//GEN-LAST:event_boton_frenarActionPerformed
    ...
    private javax.swing.JButton boton_encendido;
